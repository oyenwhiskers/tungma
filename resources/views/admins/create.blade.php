...
<div class="tm-header">
    <div>
        <h2 class="mb-1">New Admin</h2>
        <div class="text-muted">Create a new administrator account</div>
    </div>
                ...
                <form method="post" action="{{ route('admins.store') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('position') is-invalid @enderror" name="position" value="{{ old('position') }}" placeholder="e.g. Operations Manager">
                            @error('position')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mb-4">
                        ...
                        @error('password')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-text">Default password for the admin account (minimum 8 characters)</div>
                    </div>
        ...
        <div class="tm-card">
            <div class="tm-card-body">
                ...
                <ul class="small text-muted ps-3 mb-0">
                    ...
                    <li class="mb-2">Admin can manage companies, bills, and staff</li>
