            ...
            <div class="col-md-6">
              ...
              <select name="bus_departures_id" class="form-select @error('bus_departures_id') is-invalid @enderror">
                ...
                @foreach($busDepartures as $departure)
                  <option value="{{ $departure->id }}" {{ old('bus_departures_id') == $departure->id ? 'selected' : '' }}>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <select name="is_collected" class="form-select @error('is_collected') is-invalid @enderror">
                <option value="0" {{ old('is_collected', '0') == '0' ? 'selected' : '' }}>Uncollected</option>
                <option value="1" {{ old('is_collected') == '1' ? 'selected' : '' }}>Collected</option>
              </select>
              @error('is_collected')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
