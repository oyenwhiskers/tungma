...
<head>
    ...
    <link rel="icon" href="{{ asset('images/tungma-logo-3-removebg-preview.png') }}" type="image/png">
    ...
    <style>
        ...
        .tm-table .table tbody tr:last-child td {
            border-bottom: none;
        }
        ...
        .form-select:focus {
            ...
            box-shadow: 0 0 0 3px rgba(179, 32, 32, 0.1);
        }
        ...
        .btn-primary {
            background: linear-gradient(135deg, var(--tm-primary) 0%, var(--tm-primary-hover) 100%);
            color: #fff;
            box-shadow: 0 2px 4px rgba(179, 32, 32, 0.2);
        }

        .btn-primary:hover {
            background: linear-gradient(135deg, var(--tm-primary-hover) 0%, #7a1515 100%);
            transform: translateY(-1px);
            box-shadow: 0 4px 8px rgba(179, 32, 32, 0.3);
        }
        ...
        .badge-brand {
            background: linear-gradient(90deg, var(--tm-accent), var(--tm-primary));
            color: #fff;
        }
